...
def create_claude_mcp_server(store: MemoryStore, include_write_tools: bool = False):
    ...
    @mcp.tool(
        ...
        description=(
            "Use this when Claude needs compiled wiki notes from wiki/analyses without "
    ...
    @mcp.tool(
        ...
        description="Use this when Claude needs the full body of a wiki note by path or slug.",
        annotations=_readonly_annotations(),
        structured_output=False,
    )
