...
function App() {
  ...
  return (
    <div className="dashboard-shell">
      ...
      <button
        type="button"
        className={panelOpen ? 'dashboard-overlay-backdrop is-open' : 'dashboard-overlay-backdrop'}
      ...
      {/* Overlay Panel */}
      <div
        className={panelOpen ? 'dashboard-overlay-panel is-open' : 'dashboard-overlay-panel'}
        role="dialog"
        aria-label="Controls and Inspector"
      >
        <CompactPanelToggle
        ...
        />
        <div className="dashboard-overlay-body">
          {compactPanelTab === 'controls' ? (
            <GraphSidebar
              metrics={metrics}
              viewMode={effectiveViewMode}
